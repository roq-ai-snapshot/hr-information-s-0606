...
-- AddForeignKey
ALTER TABLE "job_application" ADD CONSTRAINT "job_application_candidate_id_fkey" FOREIGN KEY ("candidate_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
