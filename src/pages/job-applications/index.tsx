...
function JobApplicationListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('job_application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/job-applications/view/${id}`);
    }
  };
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('job_application', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            ...
            <NextLink href={`/job-applications/create`} passHref legacyBehavior>
